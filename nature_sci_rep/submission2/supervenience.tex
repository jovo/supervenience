...
\subsection*{The existence of a consistent statistical test for $\eps$-supervenience} % (fold)
...
\subsection*{The availability of a consistent statistical test for $\eps$-supervenience} % (fold)
\label{sub:uc}
