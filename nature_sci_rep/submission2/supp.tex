...
\caption{C.~elegans graph classification simulation results.  $\hL^{n'}_{F}(g_{\mt{n}})$  (the misclassification rate estimated upon with $n'=1000$ testing samples) %$\hL^{1000}_{\PP}(g_{\mt{n}})$ 
